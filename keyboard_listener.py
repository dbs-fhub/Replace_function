...
from functions import value, key_string, activate_special_key_if_pressed, deactivate_special_key_if_released, combo, \
    current_key, is_special_key_pressed, release_all_special_keys
