...
combinations = {
    ...
    'combo1': Combo(['alt'], 'u', modify, 'upper'),
    'combo2': Combo(['alt'], 'l', modify, 'lower'),
    'combo3': Combo(['alt'], 'c', modify, 'cap_first'),
    'combo4': Combo(['alt'], 'k', modify, 'cap_all'),
    'combo5': Combo(['alt'], 's', modify, 'snake_case'),
    'combo6': Combo(['alt'], 'r', modify, 'reverse')

}

keywords = {

    'help': KeyWord('--help', replace, '--help',
                    'Instead of this message, the function could instead alert emergency services 🚨🚨🚨'),
